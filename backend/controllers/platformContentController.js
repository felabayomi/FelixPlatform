...
const DEFAULT_HOMEPAGE_CONTENT = {
    ...
    cards: [
        ...
        },
        {
            ...
            imageUrl: 'https://marketing-sites-five.vercel.app/assets/wildfilm-tracker-preview.svg',
            buttonLabel: 'Download on App Store',
        ...
        },
        {
            ...
            imageUrl: 'https://marketing-sites-five.vercel.app/assets/praxis-nexus-preview.svg',
        ...
        },
        {
            id: 'live-loop-ios',
            title: 'Live Loop',
            description: 'Live Loop for iOS helps creators and teams manage live content loops, publishing rhythm, and engagement workflows on the go.',
            imageUrl: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=900&q=80',
            buttonLabel: 'Download on App Store',
            buttonLink: 'https://apps.apple.com/us/app/live-loop/id6760877693',
            note: 'Live on iOS App Store',
            comingSoon: false,
            appleBadge: true,
        },
        {
            id: 'streampilot-ios',
            title: 'StreamPilot',
            description: 'StreamPilot for iOS supports stream planning, launch control, and channel operations for creators and media teams.',
            imageUrl: 'https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=900&q=80',
            buttonLabel: 'Download on App Store',
            buttonLink: 'https://apps.apple.com/us/app/streampilot/id6757970417',
            note: 'Live on iOS App Store',
            comingSoon: false,
            appleBadge: true,
        },
        ...
        },
        {
            ...
            imageUrl: 'https://marketing-sites-five.vercel.app/assets/financial-readiness-preview.svg',
            buttonLabel: 'Download on App Store',
        ...
        },
        {
            id: 'eventloop-web',
            title: 'EventLoop',
            description: 'EventLoop web app powers event operations, scheduling, and participation tracking through a focused browser-based workspace.',
            imageUrl: 'https://images.unsplash.com/photo-1511578314322-379afb476865?auto=format&fit=crop&w=900&q=80',
            buttonLabel: 'Open EventLoop Web App',
            buttonLink: 'https://web.live-loop.live/',
            note: 'Live at web.live-loop.live',
            comingSoon: false,
            appleBadge: false,
        },
        {
            id: 'citydiscoverer-web',
            title: 'CityDiscoverer',
            description: 'CityDiscoverer web app helps users explore destinations, city guides, and discovery experiences in one unified travel surface.',
            imageUrl: 'https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?auto=format&fit=crop&w=900&q=80',
            buttonLabel: 'Visit citydiscoverer.app',
            buttonLink: 'https://citydiscoverer.app/',
            note: 'Live at citydiscoverer.app',
            comingSoon: false,
            appleBadge: false,
        },
        {
            id: 'city-discoverer-ios',
            title: 'City Discoverer Companion',
            description: 'City Discoverer Companion for iOS gives travelers a mobile companion for routes, destination planning, and city insights.',
            imageUrl: 'https://images.unsplash.com/photo-1508057198894-247b23fe5ade?auto=format&fit=crop&w=900&q=80',
            buttonLabel: 'Download on App Store',
            buttonLink: 'https://apps.apple.com/us/app/city-discoverer-companion/id6759014495',
            note: 'Live on iOS App Store',
            comingSoon: false,
            appleBadge: true,
        },
        ...
        },
        {
            ...
            buttonLink: 'https://www.felixconsult.co/',
            note: 'Live at www.felixconsult.co',
            comingSoon: false,
            appleBadge: false,
        },
        {
